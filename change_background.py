...
def main():
    ...
    try:
        ...
        st.markdown(
            f'<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;"><span>Ви обрали колір: </span><div style="width: 100%; height: 20px; background-color: rgb({r}, {g}, {b}); border: 1px solid black;"></div></div>',
